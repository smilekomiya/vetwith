...
if($email == "" || !is_mail($email)){ 
	...
	if($checkMail == 1){//メールアドレスの重複をチェック。index.phpで設定。
	...
	if($checkmail == 0 || $flag == "ok"){
		...
		$queryInsert = "INSERT INTO h_members(pre_userid,email) VALUES('$pre_user_id','$email')";
