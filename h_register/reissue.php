...
$queryCheck = "SELECT * FROM h_members WHERE email = '$email'";
...
?>
	...
	if(isset($reissueid) && isset($id) && $urlFlag){
		echo "<p><a href=\"http://localhost/php/vet/h_register/index.php?reissueid=${reissueid}&id=${id}\">→パスワード再発行画面に戻る。</a></p>";
	}
	?>
	</div>
</div>
